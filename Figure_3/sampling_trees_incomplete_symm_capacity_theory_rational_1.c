...
//here is the THEORY based on the alternation of the diffusion and maximization steps. The value can be computed bychoosing the branching factor and the depth of the tree.
