...
%p=0.5%
X1 = load('value_actions_capacity1.m'); %%low capacity
X1_th = load('value_actions_theory_capacity1.m');
X2 = load('value_actions_capacity2.m');  %%medium capacity
X2_th = load('value_actions_theory_capacity2.m');
X3 = load('value_actions_capacity3.m'); %%large capacity
X3_th = load('value_actions_theory_capacity3.m');
...
ylim([0 8])
xticks([1 5 10 20 30])
text(0.7,0.90,'$p=0.5$','Units','normalized','Color',[0 0 0],'FontSize',8,...
